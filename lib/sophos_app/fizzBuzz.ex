defmodule SophosApp.FizzBuzz do
  ...
  @spec fizz_buzz_case(pos_integer) :: [:buzz | :fizz | :fizz_buzz | number]
  def fizz_buzz_case(n) do
    n |> MyList.generate() |> process_list_case([])
  end

  @spec fizz_buzz_cond(pos_integer) :: [:buzz | :fizz | :fizz_buzz | :fizzbuzz | integer]
  def fizz_buzz_cond(n) do
    n |> MyList.generate() |> process_list_cond([])
  end

  @spec fizz_buzz_pattern(pos_integer) :: [:buzz | :fizz | :fizz_buzz | :fizzbuzz | integer]
